...
import com.atharva.exception.OrderException;
import com.atharva.exception.UserException;
import com.atharva.modal.Order;
import com.atharva.modal.User;
import com.atharva.repository.OrderRepository;
import com.atharva.response.ApiResponse;
import com.atharva.response.PaymentLinkResponse;
import com.atharva.service.OrderService;
import com.atharva.service.UserService;
import com.atharva.user.domain.OrderStatus;
import com.atharva.user.domain.PaymentStatus;
...
//		      paymentLinkRequest.put("reference_id",order.getId().toString());
		      ...
		      paymentLinkRequest.put("callback_url","https://shopwithatharva.vercel.app/payment/"+orderId);
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithatharva.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
